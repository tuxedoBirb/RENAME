...
/*public class basicEnemy{
    public GameObject bulletType;s
    public Transform firingPoint;

    public basicEnemy(GameObject bul, Transform fPoint)
    {
        bulletType = bul;
        firingPoint = fPoint;
    }
...
public class enemyAI : MonoBehaviour
{
    ...
    void Shoot()
    {
        /*Enemy e1 = new Enemy(10, "yay it works");
        Console.WriteLine("e1 Name = {0} Age = {1}", e1.bulletType, e1.firingPoint);*/
